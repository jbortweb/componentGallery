<template>
  <div
    class="relative w-full max-w-5xl mx-auto py-12 select-none flex flex-col items-center justify-center min-h-[600px]"
  ...
  <!-- Indicadores SIEMPRE debajo del carousel -->
