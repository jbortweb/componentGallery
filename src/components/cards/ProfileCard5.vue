<template>
  <div class="profile-card-5 group relative bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden transition-all duration-500 hover:shadow-xl hover:-translate-y-1">
    ...
    <button 
      @click="showCode"
      class="absolute top-4 right-4 bg-indigo-600 hover:bg-indigo-500 text-white p-2 rounded-full transition-all duration-300 hover:scale-110 shadow-lg z-10"
