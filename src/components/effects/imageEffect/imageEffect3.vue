<template>
  ...
  >
    ...
    >
      <span class="block text-xl font-semibold uppercase tracking-wider"
        >Frontend</span
      >
      <span class="block text-lg font-bold">Developer</span>
    </div>
...
import imageEffect3Code from "../../../data/codes/effects/imageEffect/imageEffect3.js";

const codeModal = ref(null);
const cardCode = imageEffect3Code;
