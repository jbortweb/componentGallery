<template>
  ...
  <header class="relative bg-black overflow-hidden">
      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center mb-12">
          <h1 class="text-6xl md:text-8xl font-black mb-6">
            ...
            <span class="block text-white font-mono tracking-widest"> ON </span>
          </h1>
    ...
    <button
      @click="showCode"
      class="absolute top-4 right-4 z-50 p-3 bg-gray-900/80 border border-cyan-500/30 rounded text-cyan-400 hover:bg-cyan-500/10 transition-all duration-200 cursor-pointer"
...
const cardCode = headCodes.Header2;
