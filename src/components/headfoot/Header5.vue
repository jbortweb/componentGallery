  ...
  <div class="relative">
    ...
    <header class="relative bg-black overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex items-center justify-between h-20">
            ...
            <div class="flex items-center group">
              <div class="relative">
                <div
                  class="w-12 h-12 bg-gradient-to-br from-green-400 via-green-500 to-green-600 rounded-lg flex items-center justify-center shadow-lg group-hover:shadow-green-500/25 transition-all duration-300"
                >
                  <span class="text-black font-mono font-bold text-lg"
                    >&gt;_</span
                  >
                </div>
                <div
              ...
              <div class="ml-4">
                <span
                  class="text-green-400 font-mono text-xl font-bold tracking-wider"
                  >CYBERTECH</span
                >
              ...
              >
                ...
                >
                  <span class="relative">
                    {{ item.name }}
                    <span
                      class="absolute -bottom-1 left-0 w-0 h-0.5 bg-green-400 transition-all duration-300 group-hover:w-full"
                    ></span>
                  </span>
                </a>
            ...
            <div class="flex items-center space-x-4">
              ...
              <button class="hidden md:block relative group">
                <div
                  class="absolute -inset-0.5 bg-gradient-to-r from-green-500 to-blue-500 rounded-lg blur opacity-75 group-hover:opacity-100 transition duration-200"
                ></div>
                <div
                  class="relative bg-black border border-green-500 text-green-400 font-mono font-bold py-3 px-6 rounded-lg group-hover:bg-green-500/10 transition duration-200"
                >
                  <span class="text-green-400">[</span> ACCESO
      ...
      <div class="relative z-10 px-4 sm:px-6 lg:px-8 py-16 pb-24">
        <div class="max-w-7xl mx-auto">
          <div class="relative">
            <!-- Terminal window -->
            <div
              class="bg-gray-900/80 backdrop-blur-sm border border-green-500/30 rounded-lg shadow-2xl shadow-green-500/10"
            >
              <!-- Terminal header -->
              <div
                class="flex items-center justify-between p-4 border-b border-green-500/30"
              >
              ...
              <div class="p-6 font-mono text-green-400">
                <div class="space-y-2">
                  <div class="flex items-center">
                    ...
                    <span class="ml-2" ref="typewriterText">{{
                      currentText
                    }}</span>
                  ...
                  <div v-if="showOutput" class="pl-4 space-y-1 animate-fade-in">
                    <div class="text-green-300">
                      Inicializando sistema neural avanzado...
                    </div>
                    ...
                    <div class="text-green-400">
                      ✓ Sistema listo para el futuro digital
                    </div>
                  </div>
                </div>
                ...
                <div class="mt-8 mb-6">
                  ...
                  <p class="text-xl text-green-300/80 max-w-3xl">
                    >> Desarrollando el futuro digital con tecnología cuántica
                    avanzada
                  </p>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                  <button class="group relative">
                    <div
                      class="absolute -inset-0.5 bg-gradient-to-r from-green-500 to-blue-500 rounded blur opacity-75 group-hover:opacity-100 transition duration-200"
                    ></div>
                    <div
                      class="relative bg-black border border-green-500 text-green-400 font-mono font-bold py-3 px-6 rounded group-hover:bg-green-500/10 transition duration-200"
                    >
                      > INICIAR_SESION.exe
                    </div>
                  </button>
                  ...
                  <button
                    class="border border-green-500/50 text-green-400 font-mono py-3 px-6 rounded hover:bg-green-500/10 hover:border-green-500 transition-all duration-200"
                  >
                    > explorar_sistema.sh
                  </button>
                </div>
      ...
      <div v-if="isMobileMenuOpen" class="fixed inset-0 z-50 md:hidden">
        ...
        ></div>
        <div
          class="relative bg-gray-900/95 backdrop-blur-xl border-r border-green-500/30 w-80 h-full"
        >
          <!-- Terminal mobile header -->
          <div
            class="flex items-center justify-between p-4 border-b border-green-500/30"
          >
            <span class="text-green-400 font-mono text-lg font-bold"
              >MENU.sys</span
            >
            <button
              @click="toggleMobileMenu"
              class="p-2 border border-green-500/30 rounded text-green-400"
            >
              <svg
                class="w-6 h-6"
                fill="none"
          ...
          <nav class="p-4 space-y-2 font-mono">
            <a
              ...
              @click="toggleMobileMenu"
            >
              <span class="text-green-500">[{{ index + 1 }}]</span>
              {{ item.name }}
            </a>
          </nav>
          ...
          <div
            class="absolute bottom-0 left-0 right-0 p-4 border-t border-green-500/30"
          >
            <button
              class="w-full bg-gradient-to-r from-green-500/20 to-blue-500/20 border border-green-500 text-green-400 font-mono font-bold py-3 px-6 rounded hover:bg-green-500/30 transition duration-200"
            >
              > ACCESO_TOTAL.exe
            </button>
          </div>
      ...
      <button
        @click="showCode"
        class="absolute top-4 right-4 z-50 p-3 bg-gray-900/80 backdrop-blur-sm border border-green-500/30 rounded text-green-400 hover:bg-green-500/10 transition-all duration-200 cursor-pointer"
        title="Ver código del componente"
        aria-label="Ver código del componente"
      >
        <svg
      ...
      <CodeModal
        ...
        cardVariant="Diseño terminal/matrix cyberpunk"
...
import Header5Code from "../../data/codes/headfoot/headers/Header5.js";
