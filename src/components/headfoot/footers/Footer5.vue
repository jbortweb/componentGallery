<template>
  <div class="relative">
    ...
    >
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            extraordinarias. Únete a nuestra comunidad de creadores y
            visionarios.
          </p>
        </div>
        ...
        <!-- Social Media with Gradient Icons -->
        <div
      ...
      <button
        @click="showCode"
        class="absolute top-4 right-4 z-20 w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 rounded-full flex items-center justify-center cursor-pointer transition-all"
        title="Ver código del componente"
        aria-label="Ver código del componente"
      >
        <svg
      ...
      <CodeModal
        ref="codeModal"
        cardType="Footer"
        cardVariant="Con iconos de gradiente"
