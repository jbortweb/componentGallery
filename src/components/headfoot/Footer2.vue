<template>
  <footer class="bg-white border-t-2 border-gray-100 relative">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-12">
        ...
        <!-- Connect -->
        <div>
          <h3 class="font-semibold text-gray-900 mb-4">Conecta</h3>
          <ul class="space-y-2">
            <li>
              <a
                href="#"
      ...
      <!-- Stats Section -->
      <div
        class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12 py-8 border-t border-b border-gray-200"
      >
        <div class="text-center">
          <div class="text-3xl font-bold text-blue-600 mb-2">500+</div>
          <div class="text-gray-600">Proyectos</div>
        </div>
        <div class="text-center">
        ...
        <div class="text-center">
          ...
          <div class="text-gray-600">Países</div>
        </div>
        <div class="text-center">
    ...
    <CodeModal
      ref="codeModal"
      cardType="Footer"
      cardVariant="Grid de enlaces organizado"
...
const cardCode = headCodes.Footer2;
